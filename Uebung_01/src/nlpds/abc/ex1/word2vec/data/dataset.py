...
from nlpds.abc.ex1.word2vec.data.tokenizer import TokenizedSentenceABC, TokenizerABC
...
class DatasetABC[Item: Word2VecSample](Sequence[Item]):
    ...
    def sentence_to_samples(
        ...
        Convert a tokenized sentence into a list of training samples.
        """
        return self._sentence_to_samples(sentence, self.sub_sampling_probs)
